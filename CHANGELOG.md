...
- **Added: Convex hull and boundary edge computation.** [`0c6c328`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/0c6c328)
...
- **Adds: Kani CI workflow and Python linting to justfile** [`5fce5ee`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/5fce5ee)
...
- **Added: Performance analysis scripts and workflow** [`d6994db`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/d6994db)
...
- **Added: Performance analysis scripts and workflow** [`e1cf749`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/e1cf749)
...
- **Added: Initial project files and structure** [`2e40c54`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/2e40c54)
...
- **Added: Initial CDT property validation framework** [`fb5da74`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fb5da74)
...
- **Added: Configures logging and error handling** [`45df1b3`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/45df1b3)
...
- **Added: Implements CDT core logic and simulation framework** [`6a7c4be`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/6a7c4be)
...
- **Added: Configures Dependabot for GitHub Actions and Cargo** [`f072a82`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/f072a82)
...
- **ci: add missed unused function** [`fe7670c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fe7670c)

- **Add .codecov.yml and update dependencies in Cargo.lock** [`a2aa78a`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/a2aa78a)
...
- **Add Security audit badge** [`0cc6efd`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/0cc6efd)

- **Add triangulation2** [`628aff1`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/628aff1)

- **feat: Add generate_random_delaunay2 function** [`c79e2b0`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/c79e2b0)
...
- **Update dependencies versions in Cargo.lock and add random point generation to triangulation.rs**
  [`f534a5e`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/f534a5e)
...
- **Add clippy and kani CI badges to README.md** [`78246de`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/78246de)
...
- **Add print statement to display the number of triangles** [`de1ce9d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/de1ce9d)

  This commit adds a print statement to display the number of triangles in the triangulation.

- **feat: Add rand crate as a dependency** [`fa4df1b`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fa4df1b)
...
- **Update syn version to 2.0.35, cspell.json with new words, and add a test for run function.**
  [`76281a6`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/76281a6)
...
- **feat: Add support for timeslices in CLI** [`a5c704d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/a5c704d)
...
- **Create LICENSE** [`edffe14`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/edffe14)

- **Added useful and passing Kani verification** [`a78c792`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/a78c792)
...
- **feat: Add command line argument for number of vertices** [`0b89a88`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/0b89a88)
...
- **Add verification module for Kani configuration** [`39646c0`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/39646c0)
...
- **Add Codecov badge to README.md** [`d7adf30`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/d7adf30)

  - Add Codecov badge to the README.md file.
  - Update the link to the Codecov page for cdt-rs repository.

- **Add GitHub workflows for code coverage and Kani Rust Verifier** [`eb07352`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/eb07352)
...
- **Refactor code and add proof for triangle center in circumcircle** [`b12731d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/b12731d)
...
- **Add test kani formal verification** [`84edb8c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/84edb8c)
...
- **Separate libs from cli and add tests** [`dd049b3`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/dd049b3)

- **Update codeql-action version and add CI badge to README** [`64e4f1b`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/64e4f1b)

  - Update the `codeql-action` version from `v1` to `v2` in `.github/workflows/rust-clippy.yml`
  - Add a CI badge to the README file

- **Create rust-clippy.yml** [`7073fc0`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/7073fc0)

- **feat: Add CODEOWNERS file and security audit workflow** [`ead82d2`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/ead82d2)
...
- **Create ci.yml** [`238b474`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/238b474)

- **Create README.md** [`9797804`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9797804)

### Changed

- **Bump taiki-e/install-action from 2.65.1 to 2.68.6** [`025e514`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/025e514)
...
- **Bump astral-sh/setup-uv from 7.1.6 to 7.3.0** [`d8b0667`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/d8b0667)
...
- **Bump actions/checkout from 5.0.1 to 6.0.2** [`50a3a48`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/50a3a48)
...
- **Bump actions/setup-python from 6.1.0 to 6.2.0** [`3fa4378`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/3fa4378)
...
- **Merge pull request #34 from acgetchell/feat/convex-hulls** [`2ca86c7`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/2ca86c7)

  Added: Convex hull and boundary edge computation.

- **Changed: Improves performance baseline comparisons** [`dcf64ec`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/dcf64ec)
...
- **Changed: Improves CI and audit workflows** [`ab69abf`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/ab69abf)
...
- **Changed: Improves CI/audit workflows and scripts** [`7f7b32c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/7f7b32c)
...
- **Changed: Refactors CI workflow for improved tooling and audit** [`995530d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/995530d)
...
- **Changed: Updates tooling and CI configurations** [`513847d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/513847d)

  Updates tooling configurations for linters,
  formatters, and CI workflows, improving code
  quality and maintainability (internal).

- **Bump actions/checkout from 5.0.0 to 6.0.1** [`a58bb11`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/a58bb11)
...
- **Bump actions/cache from 4 to 5** [`08957fc`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/08957fc)
...
- **Bump astral-sh/setup-uv from 7.1.1 to 7.1.6** [`fd22207`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fd22207)
...
- **Bump codecov/codecov-action from 5.5.1 to 5.5.2** [`2cbe0aa`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/2cbe0aa)
...
- **Merge pull request #33 from acgetchell/refactor/update-delaunay** [`8f79838`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/8f79838)

  refactor: update use of delaunay crate

- **Changed: Updates CI workflow tool versions** [`2aa55b2`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/2aa55b2)
...
- **Changed: Improves CI workflow with version pinning and checksums** [`e5c391e`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/e5c391e)
...
- **Changed: Updates actionlint version and installation process** [`5341b14`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/5341b14)
...
- **Changed: Pin shfmt version for CI consistency** [`01d37fe`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/01d37fe)
...
- **Changed: Refactors performance analysis and adds type checking** [`47a6f4d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/47a6f4d)
...
- **CI/Tools: install actionlint and harden scripts** [`aed2f48`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/aed2f48)
...
- **Refactor: Improve changelog tooling and cache invalidation** [`6563a84`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/6563a84)
...
- **Refactor: Improve triangulation backend and tooling** [`ee00f97`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/ee00f97)
...
- **Merge branch 'main' into refactor/update-delaunay** [`860559f`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/860559f)

- **Bump the dependencies group across 1 directory with 7 updates** [`dc79541`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/dc79541)
...
- **Bump actions/upload-artifact from 4.6.2 to 6.0.0** [`5f5de78`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/5f5de78)
...
- **Bump actions/setup-python from 6.0.0 to 6.1.0** [`31ba11c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/31ba11c)
...
- **Bump clap from 4.5.49 to 4.5.50 in the dependencies group** [`b6e1d89`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/b6e1d89)
...
- **Bump astral-sh/setup-uv from 7.1.0 to 7.1.1** [`afceea3`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/afceea3)
...
- **refactor: update use of delaunay crate** [`c4eef3c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/c4eef3c)
...
- **Merge remote-tracking branch 'origin/main'** [`c36740a`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/c36740a)

- **refactor: update tooling and backend compatibility** [`5aa1ee8`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/5aa1ee8)
...
- **Bump actions-rust-lang/setup-rust-toolchain from 1.15.0 to 1.15.2**
  [`76b881a`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/76b881a)
...
- **Bump astral-sh/setup-uv from 6.8.0 to 7.1.0** [`67bb4dc`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/67bb4dc)
...
- **Bump actions/github-script from 7.0.1 to 8.0.0** [`fbbd871`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fbbd871)
...
- **Merge pull request #11 from acgetchell/feature/testing-and-performance-infrastructure**
  [`7bf248c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/7bf248c)

  Feature/testing and performance infrastructure

- **Changed: Improves changelog generation and performance analysis** [`8e04d89`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/8e04d89)
...
- **Changed: Improves clippy-sarif tooling installation and cache** [`4c455c9`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/4c455c9)
...
- **Changed: Enhances testing and performance infrastructure** [`fc513ac`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fc513ac)
...
- **Merge branch 'main' into refactor/isolation-of-delaunay-crate** [`c10aeaf`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/c10aeaf)

- **Bump astral-sh/setup-uv from 6.7.0 to 6.8.0** [`db2daee`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/db2daee)
...
- **Merge pull request #7 from acgetchell/refactor/integrate-with-delaunay**
  [`95f2b70`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/95f2b70)

  Changed: Refactors triangulation and updates dependencies

- **Changed: Refactors triangulation creation and simulation runs** [`ffa6e35`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/ffa6e35)
...
- **🔧 Build System: Integrates criterion for benchmarking** [`9891b8b`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9891b8b)
...
- **Changed: Improves test coverage and adds Kani proofs** [`16aae91`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/16aae91)
...
- **Changed: Refactors triangulation backend with trait-based geometry**
  [`c05f637`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/c05f637)
...
- **Changed: Refactors triangulation and simulation architecture** [`4d56e07`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/4d56e07)
...
- **Changed: Refactors Kani workflow and updates dependencies** [`aab33e2`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/aab33e2)
...
- **Changed: Refactors triangulation and updates dependencies** [`0601450`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/0601450)
...
- **Bump actions/checkout from 4 to 5** [`ee667c9`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/ee667c9)
...
- **Bump actions/cache from 4.2.4 to 4.3.0** [`7d3a7f2`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/7d3a7f2)
...
- **Changed: Refactors triangulation and setup process (internal)** [`642e824`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/642e824)
...
- **chore: update dependencies** [`5ed0203`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/5ed0203)

- **ci: Ignore unused functions** [`6c43277`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/6c43277)

  These should get replaced by <https://github.com/acgetchell/d-delaunay>

- **ci: Ignore cargo kani for Codecov** [`4732a05`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/4732a05)

- **Update dependencies** [`af94c11`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/af94c11)

- **ci: Update dependencies** [`b191596`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/b191596)

- **doc: Update status badges** [`000cba5`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/000cba5)

- **ci: Update GitHub actions** [`6b38039`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/6b38039)

- **build: update crates** [`cbdb784`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/cbdb784)

- **Update package versions in Cargo.lock:** [`22745d3`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/22745d3)

  - Updated versions for multiple packages
  - Changed checksums for updated packages

- **Update dependencies in Cargo.toml and Cargo.lock** [`a19ff71`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/a19ff71)
...
- **First pass at DCEL** [`8d20c3b`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/8d20c3b)
...
- **Update some dependencies** [`9001a8d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9001a8d)

- **Refactor code to use external crates for command line arguments and 2D Delaunay triangulation**
  [`dbd144c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/dbd144c)
...
- **Merge remote-tracking branch 'origin/main' into main** [`3be06b4`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/3be06b4)

- **Update cargo** [`28ef382`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/28ef382)

- **Update Kani CI workflow and dependencies, print vertex positions and triangle positions.**
  [`fa01d09`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fa01d09)
...
- **Update README** [`bae27db`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/bae27db)

- **Kani and spade don't get along** [`3d084ea`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/3d084ea)
...
- **Trying out using Spade** [`8542cf4`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/8542cf4)
...
- **Refactor Delaunay triangulation code** [`0564e2d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/0564e2d)
...
- **Update Codecov workflow to upload coverage reports and archive code coverage results**
  [`0f7c9bf`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/0f7c9bf)
...
- **Refactor GitHub workflow files for improved code coverage and caching**
  [`6a23ed8`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/6a23ed8)
...
- **Refactor codecov.yml and lib.rs** [`b5464e3`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/b5464e3)

  - Remove version specification in codecov.yml
  - Comment out unused code in verification module

- **Refactor package and test names to use kebab-case** [`4447215`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/4447215)
...
- **Update README.md** [`296b984`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/296b984)

- **Refactor Triangle struct and variable names** [`9ae71ce`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9ae71ce)

  - Refactored the Triangle struct in main.rs
  - Renamed the center variable to _center for clarity

- **First commit** [`9931dd3`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9931dd3)

### Removed

- **chore: remove Node.js/markdownlint infrastructure and fix stale docs**
  [`d9d74d9`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/d9d74d9)
...
- **Remove DCEL** [`45b2a17`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/45b2a17)

  We'll use our own Delaunay triangulation library instead. DCEL is only good for 2D Delaunay triangulations.

- **Refactor Codecov workflow and remove unnecessary code** [`2a6616a`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/2a6616a)
...
- **Fixed: Handles exceptions when getting CPU info, Kani, CI hardening**
  [`da415a5`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/da415a5)
...
- **Fixed: Correctly identifies estimates files in criterion runs** [`83f9de0`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/83f9de0)
...
- **Fix changelog_utils and performance_analysis and update CHANGELOG.md**
  [`38162bd`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/38162bd)
...
- **Pre-merge fixes** [`0f6ec5a`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/0f6ec5a)
...
- **Fix config.rs and other script errors** [`916d103`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/916d103)
...
- **Fixed: Validates config and handles CLI arg parsing errors** [`cde9605`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/cde9605)
...
- **Fixed: Action linearity check overflow and Tds deprecation** [`803ab24`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/803ab24)
...
- **Fixed: Validates Delaunay property in CDT triangulation** [`ebff8ac`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/ebff8ac)
...
- **ci: fix CodeCov** [`ef8ae5b`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/ef8ae5b)

- **ci: Fix** [`e7fc2b8`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/e7fc2b8)

- **build: fix libc** [`9ff914d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9ff914d)

- **Spade fixed.** [`58a78a6`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/58a78a6)

- **Fix spade to version 2.2.1** [`cfb0cae`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/cfb0cae)

  Update README

- **Fix modules** [`3d11b0c`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/3d11b0c)

- **Fix Kani** [`b36e6ae`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/b36e6ae)

- **Update Rust toolchain version and fix formatting in Triangle struct**
  [`6e46ced`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/6e46ced)
...
- **Merge pull request #27 from acgetchell/dependabot/github_actions/actions/checkout-6.0.1**
  [`be2bec8`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/be2bec8)

  Bump actions/checkout from 5.0.0 to 6.0.1

- **Merge pull request #29 from acgetchell/dependabot/github_actions/actions/cache-5**
  [`e7f5bd0`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/e7f5bd0)

  Bump actions/cache from 4 to 5

- **Merge pull request #30 from acgetchell/dependabot/github_actions/astral-sh/setup-uv-7.1.6**
  [`1a0889d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/1a0889d)
...
- **Merge pull request #31 from acgetchell/dependabot/github_actions/codecov/codecov-action-5.5.2**
  [`c19ad13`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/c19ad13)
...
- **Merge pull request #26 from acgetchell/dependabot/cargo/dependencies-d5a2785ed2**
  [`a35c160`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/a35c160)
...
- **Merge pull request #32 from acgetchell/dependabot/github_actions/actions/upload-artifact-6.0.0**
  [`d984312`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/d984312)
...
- **Merge pull request #25 from acgetchell/dependabot/github_actions/actions/setup-python-6.1.0**
  [`5459160`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/5459160)
...
- **Merge pull request #17 from acgetchell/dependabot/github_actions/astral-sh/setup-uv-7.1.1**
  [`f6453f1`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/f6453f1)

  Bump astral-sh/setup-uv from 7.1.0 to 7.1.1

- **Merge branch 'main' into dependabot/github_actions/astral-sh/setup-uv-7.1.1**
  [`2d341d7`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/2d341d7)

- **Merge pull request #16 from acgetchell/dependabot/cargo/dependencies-acf088eaf4**
  [`cb5eecf`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/cb5eecf)
...
- **Merge pull request #14 from acgetchell/dependabot/github_actions/actions-rust-lang/setup-rust-toolchain-1.15.2**
  [`b7a39e9`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/b7a39e9)

  Bump actions-rust-lang/setup-rust-toolchain from 1.15.0 to 1.15.2

- **Merge branch 'main' into dependabot/github_actions/actions-rust-lang/setup-rust-toolchain-1.15.2**
  [`9e494d8`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9e494d8)

- **Merge pull request #13 from acgetchell/dependabot/github_actions/astral-sh/setup-uv-7.1.0**
  [`41be034`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/41be034)
...
- **Merge pull request #15 from acgetchell/dependabot/github_actions/actions/github-script-8.0.0**
  [`a5bc67d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/a5bc67d)
...
- **Merge pull request #9 from acgetchell/dependabot/github_actions/astral-sh/setup-uv-6.8.0**
  [`768a410`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/768a410)
...
- **Merge pull request #3 from acgetchell/dependabot/github_actions/actions/cache-4.3.0**
  [`9ce5e23`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/9ce5e23)

  Bump actions/cache from 4.2.4 to 4.3.0

- **Merge branch 'main' into dependabot/github_actions/actions/cache-4.3.0**
  [`430a927`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/430a927)

- **Merge pull request #4 from acgetchell/dependabot/github_actions/actions/checkout-5**
  [`8b8ca5e`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/8b8ca5e)

  Bump actions/checkout from 4 to 5

- **Merge branch 'main' into dependabot/github_actions/actions/checkout-5**
  [`fb9d09d`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/fb9d09d)
