...
- **Bump MSRV to 1.92.0** [`abcdef123`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/abcdef123)
  Details that should not appear in the breaking-changes summary.

- **Regular change** [`123456789`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/123456789)

### Added

- **Some new feature** [`999999999`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/999999999)
"""
...
- **Switch to insert\\_transactional** [`abcdef123`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/abcdef123)
...
- **Removed public API: Foo::bar()** [`abcdef123`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/abcdef123)
...
- **Incompatible change: Foo now requires Bar** [`abcdef123`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/abcdef123)
...
- **Top level item**
  [`{top_sha}`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/{top_sha})

  - Nested item
    [`{nested_sha}`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/{nested_sha})
"""
    ...
    def test_added_section_consolidates_many_entries_from_same_commit(self):
        ...
        url = f"https://github.com/acgetchell/causal-dynamical-triangulations/commit/{sha}"
...
- **Fix retriable dets edge case** [`beefbeef0`](https://github.com/acgetchell/causal-dynamical-triangulations/commit/beefbeef0)
"""
